...
<div class="dropdown">
    ...
    <div class="dropdown-menu" id="requestMenu">
        ...
        <a href="{{ route('referral.specialist-referral.select') }}">
            <span>🧑</span>
            Specialist Referral
        </a>

        <a href="{{ route('pathology.select') }}">
            <span>🧪</span>
            Pathology Referral
        </a>
    </div>
    ...
    <p class="header-description">
        Track your specialist and pathology referral requests, view their status, and access approved referrals.
    </p>
</div>
