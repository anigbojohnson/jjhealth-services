...
@extends('welcome')
@section('title',"Carer's medical certificate")
@section('content')
...
<form  method="POST" class="form-container" id='carer-form-details'>
            @csrf
            
    <div class="row">
           <div class="form-group mt-4 col-md-12">
                <label for="careForSomeone">Are You caring for someone within this period ?</label>
                <div>
                    <input type="hidden" name="careForSomeone" id="careForSomeone" value="{{ old('careForSomeone') }}" >
                    <button type="button" class="btn btn-outline-primary option-btn" data-target="careForSomeone"  data-value="Yes" style="width:40%; height:40px; margin-right:5px;">Yes</button>
                    <button type="button" class="btn btn-outline-primary option-btn" data-target="careForSomeone"  data-value="No" style="width:40%; height:40px; margin-left:5px;">No</button>
                    <div class="text-danger" id="careForSomeone-error"></div>
    ...
    <div  id="personCaredFor" class="row">
    
        <div class="col-md-12">
            <div class="form-group">
                <label style="font-weight: 600;" for="personCared" class="form-label">Who are you caring for ?</label>
                <select class="form-select genderSelector" name="personCared" id="personCared" value="{{ old('personCared') }}" required>
                    <option value="noOption">please select an option</option>
                    <option value="child">Child</option>
                    <option value="parent">Parent</option>
                    <option value="partner">Partner</option>                   
                </select>
                <span class="text-danger" id="personCared-error"></span>
            </div>
        </div>
    </div>
...
<div id="medicalDetails">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form id="register-medicalDetail-form" class="form-container">
            @csrf
