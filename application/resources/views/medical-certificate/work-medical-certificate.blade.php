            ...
            <form id="work-register-form" class="form-container">
                ...
                <div class="mb-3">
                    <label for="jobDescription" class="form-label">
                        What is your job and description (i.e. Engineer, Teacher)? 
                    ...
                    <div id="jobDescription_error" class="invalid-feedback"></div>

                </div>
                <div class="mb-3">
                    <label for="symptomsRelationToJobs" class="form-label">
                        Explain to the doctor how your current medical issue and its accompanying symptoms are impacting your study
                        <span class="text-danger">*</span>
                    </label>
                    <textarea 
                        class="form-control" 
                        id="symptomsRelationToJobs" 
                        name="symptomsRelationToJobs" 
                        rows="5"
                        >
                    </textarea>
                    <div class="invalid-feedback" id="symptomsRelationToJobs-error"></div>
                </div>
                ...
                <div class="row mt-5 gy-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <button type="submit" id="validate-work-details" class="btn btn-dark btn-block w-100">Continue</button>
                        </div>
                    </div>
                </div>
            </form>
...
<div id="medicalDetails">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            ...
            @endif
                <b><p>Note</p></b>
                <li>If suitable, your Partner Doctor might change the date based on what they believe is appropriate.</li>
           </div>
