    ...
    <div id="consultationRequest">
        <div class="row justify-content-center gy-3">
            ...
            <form id="consultation-loss-form" method="POST" class="form-container mt-5">
                @csrf
                <div class="form-group">
                    <label class="fw-medium"> What is the reason for your request?</label>
                    <div class="mt-2">
                ...
                <div class="form-group mt-4">
                    <label class="fw-medium">Please enter your height (in cm).</label>
                    <div class="mt-2">
                ...
                <div class="form-group mt-4 mb-4">
                    <label class="fw-medium"> Please enter your weight (in kg).</label>
                    <div class="mt-2">
    ...
    <div class="row justify-content-center gy-3">
        ...
        <form id="medical-detail-form" method="POST" action="{{ route('weight-loss-medical-details') }}" class="form-container">
            ...
            <div class="row mt-4 gy-3">
                <div class="col-md-6">
                    <div class="form-group">
                        <button type="button" id="back-consultDetails" class="btn btn-light btn-block rounded border border-grey w-100">Back</button>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <button type="submit" id="submit-weight-loss" class="btn btn-dark btn-block w-100">Continue</button>
                    </div>
                </div>
            </div>
